...
_LEGSIZE = DESCRIPTOR.message_types_by_name['LegSize']
_LEGSIZECONFIGURATIONREQUEST = DESCRIPTOR.message_types_by_name['LegSizeConfigurationRequest']
_LEGSIZECONFIGURATIONRESPONSE = DESCRIPTOR.message_types_by_name['LegSizeConfigurationResponse']
_LEGSIZECONFIGURATIONSTATEREQUEST = DESCRIPTOR.message_types_by_name['LegSizeConfigurationStateRequest']
_LEGSIZECONFIGURATIONSTATERESPONSE = DESCRIPTOR.message_types_by_name['LegSizeConfigurationStateResponse']
...
_LEGSIZECONFIGURATIONRESPONSE_STATUS = _LEGSIZECONFIGURATIONRESPONSE.enum_types_by_name['Status']
...
LegSize = _reflection.GeneratedProtocolMessageType('LegSize', (_message.Message,), {
  'DESCRIPTOR' : _LEGSIZE,
  '__module__' : 'bosdyn.api.spot.choreography_sequence_pb2'
  # @@protoc_insertion_point(class_scope:bosdyn.api.spot.LegSize)
  })
_sym_db.RegisterMessage(LegSize)

LegSizeConfigurationRequest = _reflection.GeneratedProtocolMessageType('LegSizeConfigurationRequest', (_message.Message,), {
  'DESCRIPTOR' : _LEGSIZECONFIGURATIONREQUEST,
  '__module__' : 'bosdyn.api.spot.choreography_sequence_pb2'
  # @@protoc_insertion_point(class_scope:bosdyn.api.spot.LegSizeConfigurationRequest)
  })
_sym_db.RegisterMessage(LegSizeConfigurationRequest)

LegSizeConfigurationResponse = _reflection.GeneratedProtocolMessageType('LegSizeConfigurationResponse', (_message.Message,), {
  'DESCRIPTOR' : _LEGSIZECONFIGURATIONRESPONSE,
  '__module__' : 'bosdyn.api.spot.choreography_sequence_pb2'
  # @@protoc_insertion_point(class_scope:bosdyn.api.spot.LegSizeConfigurationResponse)
  })
_sym_db.RegisterMessage(LegSizeConfigurationResponse)

LegSizeConfigurationStateRequest = _reflection.GeneratedProtocolMessageType('LegSizeConfigurationStateRequest', (_message.Message,), {
  'DESCRIPTOR' : _LEGSIZECONFIGURATIONSTATEREQUEST,
  '__module__' : 'bosdyn.api.spot.choreography_sequence_pb2'
  # @@protoc_insertion_point(class_scope:bosdyn.api.spot.LegSizeConfigurationStateRequest)
  })
_sym_db.RegisterMessage(LegSizeConfigurationStateRequest)

LegSizeConfigurationStateResponse = _reflection.GeneratedProtocolMessageType('LegSizeConfigurationStateResponse', (_message.Message,), {
  'DESCRIPTOR' : _LEGSIZECONFIGURATIONSTATERESPONSE,
  '__module__' : 'bosdyn.api.spot.choreography_sequence_pb2'
  # @@protoc_insertion_point(class_scope:bosdyn.api.spot.LegSizeConfigurationStateResponse)
  })
_sym_db.RegisterMessage(LegSizeConfigurationStateResponse)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'B\021ChoreographyProtoZ%bosdyn/api/spot/choreography_sequence'
  ...
  _LEGSIZE._serialized_start=15571
  _LEGSIZE._serialized_end=15684
  _LEGSIZECONFIGURATIONREQUEST._serialized_start=15687
  _LEGSIZECONFIGURATIONREQUEST._serialized_end=15963
  _LEGSIZECONFIGURATIONRESPONSE._serialized_start=15966
  _LEGSIZECONFIGURATIONRESPONSE._serialized_end=16182
  _LEGSIZECONFIGURATIONRESPONSE_STATUS._serialized_start=16112
  _LEGSIZECONFIGURATIONRESPONSE_STATUS._serialized_end=16182
  _LEGSIZECONFIGURATIONSTATEREQUEST._serialized_start=16184
  _LEGSIZECONFIGURATIONSTATEREQUEST._serialized_end=16261
  _LEGSIZECONFIGURATIONSTATERESPONSE._serialized_start=16264
  _LEGSIZECONFIGURATIONSTATERESPONSE._serialized_end=16547
