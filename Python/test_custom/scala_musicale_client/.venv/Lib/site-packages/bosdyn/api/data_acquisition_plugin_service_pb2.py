...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B!DataAcquisitionPluginServiceProtoZ*bosdyn/api/data_acquisition_plugin_service'
