...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\035ArmSurfaceContactServiceProtoZ&bosdyn/api/arm_surface_contact_service'
