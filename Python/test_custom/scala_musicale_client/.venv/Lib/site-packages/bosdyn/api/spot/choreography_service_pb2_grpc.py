...
class ChoreographyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LegSizeConfiguration = channel.unary_unary(
                '/bosdyn.api.spot.ChoreographyService/LegSizeConfiguration',
                request_serializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationRequest.SerializeToString,
                response_deserializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationResponse.FromString,
                )
        self.LegSizeConfigurationState = channel.unary_unary(
                '/bosdyn.api.spot.ChoreographyService/LegSizeConfigurationState',
                request_serializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationStateRequest.SerializeToString,
                response_deserializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationStateResponse.FromString,
                )
...
class ChoreographyServiceServicer(object):
    ...
    def LegSizeConfiguration(self, request, context):
    ...
    def LegSizeConfigurationState(self, request, context):
...
def add_ChoreographyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'LegSizeConfiguration': grpc.unary_unary_rpc_method_handler(
                    servicer.LegSizeConfiguration,
                    request_deserializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationRequest.FromString,
                    response_serializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationResponse.SerializeToString,
            ),
            'LegSizeConfigurationState': grpc.unary_unary_rpc_method_handler(
                    servicer.LegSizeConfigurationState,
                    request_deserializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationStateRequest.FromString,
                    response_serializer=bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationStateResponse.SerializeToString,
            ),
...
class ChoreographyService(object):
    ...
    @staticmethod
    def LegSizeConfiguration(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bosdyn.api.spot.ChoreographyService/LegSizeConfiguration',
            bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationRequest.SerializeToString,
            bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def LegSizeConfigurationState(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bosdyn.api.spot.ChoreographyService/LegSizeConfigurationState',
            bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationStateRequest.SerializeToString,
            bosdyn_dot_api_dot_spot_dot_choreography__sequence__pb2.LegSizeConfigurationStateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
