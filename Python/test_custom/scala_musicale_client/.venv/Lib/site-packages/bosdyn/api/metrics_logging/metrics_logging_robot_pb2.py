...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\030MetricsLoggingRobotProtoZ0bosdyn/api/metrics_logging/metrics_logging_robot'
