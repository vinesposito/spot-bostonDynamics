...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\037MetricsLoggingRobotServiceProtoZ8bosdyn/api/metrics_logging/metrics_logging_robot_service'
